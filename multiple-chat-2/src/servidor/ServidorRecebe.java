        ...
        try {
            ...
            while (true) {
                ...
                if (info.equals("1")) {   // 1 para Nova requisição de mensagem
                    TelaServidor.console.append("Tin nhắn mới ---->> " + line + "\r\n");
                    ...
                    if (!nomeUsuario.contains(line)) {
                        TelaServidor.console.append("Yêu cầu đăng nhập mới ---->> " + line + "\r\n");
                        TelaServidor.console.setCaretPosition(TelaServidor.console.getText().length());
                        ...
                        TelaServidor.console.append("Đăng nhập trùng lặp ---->> " + line + "\r\n");
                        TelaServidor.console.setCaretPosition(TelaServidor.console.getText().length());
                        listaUsuario.remove(socket);
                        new ServidorEnvia(socket, "", "4");
                    }
                } else if (info.equals("3")) {  // 3 para sair
                    TelaServidor.console.append("Nó đi ra ngoài ---->> " + line + "\r\n");
                    TelaServidor.console.setCaretPosition(TelaServidor.console.getText().length());
                    ...
                    TelaServidor.console.append("Tin nhắn riêng mới ---->> " + line + "\r\n");
                    TelaServidor.console.setCaretPosition(TelaServidor.console.getText().length());
